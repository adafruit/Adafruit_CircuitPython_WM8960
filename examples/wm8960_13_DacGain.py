...
print("Example 13 - DAC Digital Volume Control")
...
while True:
    ...
    # Map it from 0-4096, to a dB value that is acceptable in the DAC digital volume control (-97.50 [MUTE] to +30dB)
    dacVolumeDB = map_range(userInputA0, 0.0, 65536.0, 30.0, -97.5)

    print("dacVolumeDB: ", dacVolumeDB)

    codec.setDacDigitalVolumeDB(dacVolumeDB) # -97.50 to +30.00dB
